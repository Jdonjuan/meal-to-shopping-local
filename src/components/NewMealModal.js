      ...
      <div className='meal-modal-wrapper'>
        ...
        <div className='meal-modal-card'>
          ...
          <div className='name-row'>
            <label>Name</label>
            <input className='meal-name-input-field' type='text' onChange={updateMealName} placeholder='Meal Name...' ></input>
          </div>
          ...
          <div className='meal-modal-footer-wrapper'>
            <div className='meal-modal-footer-button-row'>
              ...
              <button className='meal-modal-add-meal-button' onClick={SaveMeal} >Create New Meal</button>
            </div>
          </div>
        </div>
      </div>
