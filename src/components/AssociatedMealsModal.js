...
export default function AssociatedMealsModal({
  appState, 
  setAppState, 
  modalOpen, 
  setModalOpen, 
  ...
  console.log('modal Item', modalItem.associatedMeals);
    ...
    <>
      <style>
        {`
          ...
          .associated-meals-checklist-container {
            text-align: left;
            display: inline-flex;
            flex-direction: column;
            overflow-y: auto;
          ...
          .associated-meals-checklist-item {
            display: flex;
            font-size: 16px;
            // border-bottom: 1px solid lightgray;
            padding-top: 4px;
      ...
      <div className='meal-modal-wrapper'>
        ...
        <div className='meal-modal-card'>
          ...
          <div className='associated-meals-checklist-container'>
            {modalItem.associatedMeals.length <= 0 && <p>No items</p>}            
            {modalItem.associatedMeals.map((item, index) => {
              let itemObj = {name: item};
              return (
